...
export const Navbar = () => { // Renamed from HeroHeader
    ...
    React.useEffect(() => {
        ...
        if (currentPath === '/' || currentPath === '/home') {
            ...
            setCurrentSections(['how-it-works']); // Track the how-it-works section on user page
        } else {
            setCurrentSections([]);
        }
    ...
    const getMenuItems = () => {
        ...
        const baseItems = [
            ...
            { name: 'FAQs', to: '/#faq-section', description: 'Common questions answered' },
            ...
            <motion.nav
                ...
                <div className={cn(
                    ...
                    scrolled ? 'mt-0.5 mb-0.5 sm:mt-1 sm:mb-0' : 'mt-2 mb-2 sm:mt-3 sm:mb-0'
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-white/[0.03] via-white/[0.01] to-blue-500/[0.02] opacity-50 hover:opacity-80 transition-all duration-1000" />
                        <div className={cn(
                            "absolute inset-0 rounded-3xl transition-all duration-700",
                            "bg-gradient-to-r from-blue-400/[0.05] via-transparent to-purple-400/[0.05]",
                                    ...
                                    {menuItems.map((item, index) => (
                                        <li key={index} className="relative">
                                            <Link
                                                ...
                                                <motion.div
                                                    className="absolute inset-0 bg-gradient-to-r from-blue-500/[0.15] via-blue-400/[0.2] to-blue-500/[0.15] rounded-xl backdrop-blur-sm border border-blue-400/[0.3]"
                    ...
                    {menuState && (
                        <>
                            ...
                            <motion.div
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br from-white/[0.02] via-transparent to-blue-500/[0.015]" />
